export default async function handler(req, res) {
    ...
    try {
        ...
        const charConfig = {
            ...
            "3": { name: "คุณฤทัย", voice: "th-TH-PremwadeeNeural", rate: "1.0", pitch: "+2%", gender: "female", context: "คุณแม่ลูกอ่อนที่กำลังยุ่งอยู่กับการป้อนข้าวลูก มีเสียงเด็กกวนใจตลอดเวลา อารมณ์แปรปรวนและใจร้อนมาก" },
